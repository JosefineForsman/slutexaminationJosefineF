    ...
    for (let i =0; i<planetElems.length; i++){
        planetElems[i].addEventListener('click', async () =>{
            ...
            <section> 
                ...
                <p class="Omkrets">${ListOfPlanets.bodies[i].circumference} km </p>
                <h3 class="MaxTempRubirk">MAX TEMPERATUR: </h3>
                <p class="Maxtemperatur">${ListOfPlanets.bodies[i].temp.day}C</p>
                <h3 class="MinTempRubrik">MIN TEMPERATUR: </h3>
                <p class="Mintemperatur">${ListOfPlanets.bodies[i].temp.night}C</p>
                <h3 class="KilometerRubrik">KM FRÅN SOLEN: </h3>
                <p class="Kilometers">${ListOfPlanets.bodies[i].distance} km </p>
                <hr class="line2"/>
